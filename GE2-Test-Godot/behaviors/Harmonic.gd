...
func on_draw_gizmos():
	...
	DebugDraw3D.draw_sphere(cent, radius, Color.AQUAMARINE)
	DebugDraw3D.draw_line(boid.global_transform.origin, cent, Color.AQUAMARINE)
	DebugDraw3D.draw_line(cent, worldTarget, Color.AQUAMARINE)
